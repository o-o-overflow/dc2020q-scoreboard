...
def main():
    ...
    with open("../../challs-manager/scoreboard.json") as fp:
    ...
    with sshtunnel.SSHTunnelForwarder(
        ...
        conn = pg.connect('scoreboard', 'localhost', 5555, None,
                          'scoreboard', db_password)
        ...
        result = conn.query("update " + table_name + " set description = $1 "
                            "where id = $2", (challenge['description'],
                                              challenge_id))
